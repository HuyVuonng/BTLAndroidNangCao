...
public class NonFoodFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_non_food, container, false);
    ...
    private void getViews() {
        ...
        rcvListFood = mView.findViewById(R.id.rcv_list_non_food);
        prgbFood = mView.findViewById(R.id.prgb_non_food);
    ...
    private void getDataFromFirebase() {
        ...
        myQuery.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if(post != null && post.getType().equals(TYPE_NON_FOOD) && !post.isDelete()) {
